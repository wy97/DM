...
from FCN.model.utils import get_upsampling_weight   

from FCN.loss.loss import cross_entropy2d  


# In[ ]:


class fcn32s(nn.Module):    # not implemented
...
class fcn16s(nn.Module):    # not implemented
...
class fcn8s(nn.Module):    # fully implemented
